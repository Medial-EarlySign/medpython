...
public:
	...
	string optimization_target = "PPV_INTEGRAL"; ///< optimization target. Can be bootstrap measurement. for example PPV@PR_10 or keyword "PPV_INTEGRAL"
	...
	ADD_CLASS_NAME(FairnessPostProcessor)
		ADD_SERIALIZATION_FUNCS(processor_type, feature_name, resolved_name, reference_group_val,
			group_feature_gen_model, constraints, optimization_target, fairness_target_type, resulotion,
			group_to_score_cutoffs_ranges)
};
