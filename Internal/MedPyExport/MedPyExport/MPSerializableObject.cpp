...
int MPSerializableObject::read_from_file(const string fname) { if (o == nullptr) throw runtime_error("ERROR: SerializableObject can only be created by a .asSerializable() method"); return o->read_from_file(fname); }
int MPSerializableObject::write_to_file(const string fname) { if (o == nullptr) throw runtime_error("ERROR: SerializableObject can only be created by a .asSerializable() method"); return o->write_to_file(fname); }
