...
struct MedDeepBitParams {
	...
	MedDeepBitParams() {
		max_depth = 5; num_iterations = 100; num_ftrs_per_round = 100; num_vals_to_be_categorial = 10; nparts_auc = 1; niter_coordinate_descent = 0;
		int niter_auc_gitter = 0;  grid_fraction = 0.01; min_fraction_zeros_ones = 0.005;
		frac_continuous_frequent = 0.1; frac_categorial_frequent = 0.1; lambda = 20; fraction_auc = 1; internal_test_ratio = 10;
	}
	size_t get_size();
...
private:
	...
	vector<double> y, internal_test_y, scores, r, internal_test_scores, avx, sdx;
