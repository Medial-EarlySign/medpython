...
//----------------------------------------------------------------------------------------------------------------------------------------
int MedPatientPlotlyDate::get_rec_html(string &shtml, PidRec &rec, const string &mode, const vector<ChartTimeSign> &sign_times, const vector<string> &view)
{
	shtml = "";
