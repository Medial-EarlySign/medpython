	...
	*/
	...
	protected:
		...
		*/
		...
		std::vector<std::pair<size_t, std::string>> FeatureImportance(const std::string &method) const;
		std::vector<std::pair<size_t, std::string>> FeatureImportance() const; //Alon - for backward compitability
