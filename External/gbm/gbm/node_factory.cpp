...
{
    #ifdef NOISY_DEBUG
    fprintf(stderr,"destructing node factory\n");
    #endif
}
...
CNodeTerminal* CNodeFactory::GetNewNodeTerminal()
{
    ...
    {
        #ifdef NOISY_DEBUG
        fprintf(stderr,"Terminal stack is empty\n");
        #endif
...
CNodeContinuous* CNodeFactory::GetNewNodeContinuous()
{
    ...
    {
        #ifdef NOISY_DEBUG
        fprintf(stderr,"Continuous stack is empty\n");
        #endif
...
CNodeCategorical* CNodeFactory::GetNewNodeCategorical()
{
    ...
    {
        #ifdef NOISY_DEBUG
        fprintf(stderr,"Categorical stack is empty\n");
        #endif
